...
const form = useForm({
  companyName: {
    value: props.supplier.companyName ?? '',
    validators: {
      required,
  ...
  contactName: {
    value: props.supplier.contactName ?? '',
    validators: {
      minLength: minLength(1),
  ...
  contactTitle: {
    value: props.supplier.contactTitle ?? '',
    validators: {
      minLength: minLength(1),
      maxLength: maxLength(30),
      optional: optional,
  ...
  postalCode: {
    value: props.supplier.postalCode ?? '',
    validators: {
      minLength: minLength(1),
...
const update = () => {
  emit('update', {
    ...
    contactName:
      form.contactName.value.length !== 0 ? form.contactName.value : undefined,
    contactTitle:
      form.contactTitle.value.length !== 0
        ? form.contactTitle.value
        : undefined,
    address: form.address.value.length !== 0 ? form.address.value : undefined,
    city: form.city.value.length !== 0 ? form.city.value : undefined,
    region: form.region.value.length !== 0 ? form.region.value : undefined,
    postalCode:
      form.postalCode.value.length !== 0 ? form.postalCode.value : undefined,
    country: form.country.value.length !== 0 ? form.country.value : undefined,
    phone: form.phone.value.length !== 0 ? form.phone.value : undefined,
    fax: form.fax.value.length !== 0 ? form.fax.value : undefined,
    homePage:
      form.homePage.value.length !== 0 ? form.homePage.value : undefined,
  });
};
</script>
<style scoped>
